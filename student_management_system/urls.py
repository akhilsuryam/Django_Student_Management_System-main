...
urlpatterns = [
    ...
    path('edit_report/<str:student_id>', HodViews.edit_report,name="edit_report"),
    ...
    path('student_report', HodViews.student_report,name="student_report"),
    ...
    path('feedbackform', StudentViews.add_feedback,name="feedbackform"),
    path('add_feedback_save', StudentViews.add_feedback_save,name="add_feedback_save"),
